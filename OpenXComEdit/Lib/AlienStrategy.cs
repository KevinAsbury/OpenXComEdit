...
namespace OpenXComEdit.Lib
{
    public class AlienStrategy
    {
        ...
        private List<PossibleMission> StartingPossibleMissions()
        {
            ...
            var mi5 = new Dictionary<string, int?>();
            mi5.Add("~", null);
            var pm5 = new PossibleMission("STR_INDIAN_OCEAN", mi5);
            result.Add(pm5);
            ...
            var mi8 = new Dictionary<string, int?>();
            mi8.Add("~", null);
            var pm8 = new PossibleMission("STR_NORTH_ATLANTIC", mi8);
            result.Add(pm8);
            ...
            var mi13 = new Dictionary<string, int?>();
            mi13.Add("~", null);
            var pm13 = new PossibleMission("STR_SOUTH_ATLANTIC", mi13);
            result.Add(pm13);
